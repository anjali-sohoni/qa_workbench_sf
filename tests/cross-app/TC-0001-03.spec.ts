...
test('TC-0001-03: Submit form with maximum valid test score boundary value', async () => {
  const testData = {
    "FAFSA__c": true,
    "GPA__c": 3.91,
    "School_Name__c": "Global Solutions LLC",
    "TestScore__c": 1580,
    "Applicant_Name__c": "Meredith Grey",
    "Application_Type__c": "Graduate",
    "DOB__c": "11/05/1985",
    "Academic_Dept__c": "Math",
    "Email__c": "michael.rodriguez@example.com"
  };
